      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-3xl font-display font-bold text-secondary-400 mb-4">
              ExpreeZmeal
            </h2>
            <p className="text-primary-100 mb-6 max-w-md leading-relaxed">
              ...
              Luxury meets tradition in every bite.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/menu" className="text-neutral-300 hover:text-white transition-colors duration-200">
                  Menu
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-neutral-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="/terms-service" className="text-neutral-400 hover:text-white text-sm transition-colors duration-200">
              Terms of Service
            </Link>
            <Link href="/trust-safety" className="text-neutral-400 hover:text-white text-sm transition-colors duration-200">
              Trust & Safety
            </Link>
          </div>
        </div>
