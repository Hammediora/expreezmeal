  ...
  return (
    <div className="min-h-screen bg-elegant-cream">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Simplified elegant overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#384b42]/50 to-[#0a0a0a]/70 z-10" />
        <div className="relative z-20 text-center text-white max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="block mb-1 sm:mb-2">
              <span className="text-white drop-shadow-2xl">Taste the</span>
          ...
          >
            <span className="text-white/95 font-semibold drop-shadow-lg">
              Experience premium Nigerian fast-casual dining
            </span>
            <span className="text-white/95 drop-shadow-lg"> with our </span>
            <span className="text-secondary-500 font-bold">signature shawarma</span>
            <span className="text-white/95 drop-shadow-lg">, </span>
            <span className="text-secondary-500 font-bold">refreshing zobo</span>
            <span className="text-white/95 drop-shadow-lg">, and </span>
            <span className="text-secondary-500 font-bold">delicious meat pies</span>
            <span className="text-white/95 drop-shadow-lg">.</span>
          </motion.p>
          ...
          >
            ...
            >
              <Link href="/menu" className="btn btn-gold w-full sm:w-auto text-center">
            ...
            >
              <motion.button
                ...
                className="btn btn-secondary w-full sm:w-auto bg-gradient-to-r from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a] text-center"
              >
                <Award className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
                CHEF&apos;S PICKS
                <Award className="w-4 h-4 sm:w-5 sm:h-5 ml-2" />
              </motion.button>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="bg-[#2F4F4F] text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold shadow-lg flex items-center gap-1 sm:gap-2">
              <Zap className="w-3 h-3 sm:w-4 sm:h-4" />
              Fast Service
            </div>
            <div className="bg-secondary-500 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold shadow-lg flex items-center gap-1 sm:gap-2">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-elegant-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <span className="bg-[#2f4f4f] text-white px-6 py-2 rounded-full text-sm font-bold uppercase tracking-wide shadow-lg flex items-center gap-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-4 sm:mb-6">
              <span className="text-primary-800">Featured</span>
              <span className="text-secondary-500"> Dishes</span>
            </h2>
            ...
            <p className="text-base sm:text-lg md:text-xl text-primary-600 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="text-primary-700">
                , crafted with the finest ingredients and authentic
              </span>
              <span className="font-bold text-primary-800">
                <span> Nigerian flavors that will make your taste buds dance!</span>
              </span>
            </p>
          </motion.div>
      ...
      {/* CTA Section */}
      <section className="pt-12 sm:pt-16 pb-8 sm:pb-10 bg-gradient-to-r from-[#052e2e] via-[#152e2e] to-[#023838] text-white relative overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute inset-0">
          <div className="absolute top-10 left-10 w-20 h-20 bg-secondary-500/20 rounded-full animate-pulse"></div>
          <div className="absolute bottom-10 right-10 w-32 h-32 bg-secondary-500/20 rounded-full animate-bounce"></div>
          <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-secondary-500/20 rounded-full animate-ping"></div>
        </div>
          ...
          >
            ...
            >
              <div className="flex justify-center items-center gap-2 sm:gap-4">
                <Star className="w-8 h-8 sm:w-12 sm:h-12 text-yellow-600 animate-bounce" />
                <Award className="w-8 h-8 sm:w-12 sm:h-12 text-secondary-500 animate-pulse" />
                <Star className="w-8 h-8 sm:w-12 sm:h-12 text-yellow-600 animate-bounce" />
              </div>
            </motion.div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4 sm:mb-6">
              ...
              <br />
              <span className="text-secondary-500">Nigerian Luxury?</span>
            </h2>
            ...
            <p className="text-lg sm:text-xl mb-6 sm:mb-8 max-w-2xl mx-auto px-4 sm:px-0">
              ...
              <span className="text-secondary-500 font-bold">authentic Nigerian cuisine</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 sm:px-0">
              <motion.div
                ...
                className="w-full sm:w-auto"
              >
                <Link href="/menu" className="btn btn-gold w-full sm:w-auto">
            ...
            >
              <div className="flex items-center gap-1 sm:gap-2 bg-white/10 backdrop-blur-sm px-3 py-2 rounded-full border border-white/20">
                <Star className="w-4 h-4 sm:w-5 sm:h-5 text-[#ffdd44]" />
                <span className="font-semibold text-white">5-Star Rated</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2 bg-white/10 backdrop-blur-sm px-3 py-2 rounded-full border border-white/20">
                <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-[#f5ca55]" />
                <span className="font-semibold text-white">Quick Pickup</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2 bg-white/10 backdrop-blur-sm px-3 py-2 rounded-full border border-white/20">
                <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 text-[#d4af37]" />
                <span className="font-semibold text-white">Great Prices</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
